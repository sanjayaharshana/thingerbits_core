...
<form autocomplete="off" method="POST" action="">
    ...
    <input type="number" class="form-control" style="display:none;" id="number" name="pack_id" value=""><br>
    <input type="number" class="form-control" style="display:none;" id="number" name="product_id" value=""><br>
