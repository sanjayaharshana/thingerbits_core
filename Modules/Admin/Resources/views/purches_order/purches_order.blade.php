...
@section('content_header')
    ...
    <div class="row">
        <div class="container" style="width: 1100px;">
            <h3>Package</h3><br><br>
            <a href="admin/createpackage" class="btn btn-primary left">Add Package</a><br><br>
            ...
            <table id="table_id" class="display">
                ...
                <tbody>                   
                        <tr>
                            <td>Apple Engine</td>
                            <td style="text-align: end;"><a href="admin/editpack/" class="btn btn-primary">Edit Pack</a><span> <a href="admin/packagercreator/" class="btn btn-primary">Edit Items</a><span>  </span><a href="admin/deleteitem/" class="btn btn-danger">Delete</a></td>
                            <td>Apple Engine</td>
                            <td style="text-align: end;"><a href="admin/editpack/" class="btn btn-primary">Edit Pack</a><span> <a href="admin/packagercreator/" class="btn btn-primary">Edit Items</a><span>  </span><a href="admin/deleteitem/" class="btn btn-danger">Delete</a></td>
                            <td>Apple Engine</td>
                            <td style="text-align: end;"><a href="admin/editpack/" class="btn btn-primary">Edit Pack</a><span> <a href="admin/packagercreator/" class="btn btn-primary">Edit Items</a><span>  </span><a href="admin/deleteitem/" class="btn btn-danger">Delete</a></td>
