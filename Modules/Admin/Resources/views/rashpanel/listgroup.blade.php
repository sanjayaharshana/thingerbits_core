...
<!-- Modal -->
      <div id="addsec" class="modal fade" role="dialog">
            ...
            <div class="modal-body">
                    <form autocomplete="off" method="POST" action="{{ route('adsection') }}" enctype="multipart/form-data" id="commentForm">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <input type="text" class="form-control" id="slugg" placeholder="Slugg" name="c_id" style="" value="{{ $lesson->course_id }}" required>
                        </div>                    
                         
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Order</label>
                            <input type="number" pattern=".{160,}" required title="160 characters minimum" class="form-control" placeholder="Course Intro" name="order" style="" value="0" required>
                        </div>
                        <br>                      
                         </div>
