...
<body>
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="box-title">Traffic </h4><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                            </div>                           
                        </div>
                    </div><!-- /# column -->
                </div>
    ...
    <script src="{{ (Theme::url('public/HousePan/js/main.js')) }}"></script>
    ...
    <script src="{{ (Theme::url('public/HousePan//js/init/weather-init.js')) }}"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="{{ (Theme::url('public/HousePan/js/init/fullcalendar-init.js')) }}"></script>
