<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::checkbox('send_order_invoice_email', trans('setting::attributes.send_order_invoice_email'), trans('setting::settings.form.send_invoice_automatically'), $errors, $settings) }}
    </div>
</div>
