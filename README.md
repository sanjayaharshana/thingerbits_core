...
When logged in, someone used a multiple login controller and all Login has the same oauth, the API is also developing in golang,
and Basic settings are configured using Laravel 5.2.
...
reported by contacting the project team at sanjayaharasana@gmail.com. All
